...
- Create Angular project with ng: `ng new coctaildebucle.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`coctaildebucle.client.esproj`).
